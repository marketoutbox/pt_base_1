...
Last day (${pricesA[endIdx].date}):`)
  ...
  console.log("\
=== COMPARISON SUMMARY ===")
  console.log(`ChatGPT Beta: 4.25, Our Beta: $
    beta1
    ;`)
...
const kalmanFilter = (
  ...
  for (let i = initialLookback; i < n; i++) {
    ...
    if (i >= n - 3) {
      ...
      console.log(`
    Kalman
    Gain: [${K[0].toFixed(6)}, ${K[1].toFixed(6)}]`)
    }
  }
  ...
  console.log(`
    Final
    Alpha: $
    alphas[alphas.length - 1].toFixed(4)
    ;`)
  console.log(`
    Final
    Beta: $
    hedgeRatios[hedgeRatios.length - 1].toFixed(4)
    ;`)
  console.log(`
    Total
    iterations: $
            ...
            {analysisData.statistics.modelType !== "ratio" && (
              <div className="bg-navy-800/50 p-6 rounded-lg border border-navy-700">
                ...
                <p className="mt-4 text-sm text-gray-400">
                  ...
                  {analysisData.statistics.modelType === "kalman" && " The improved Kalman filter provides more stable and accurate estimates."}
                </p>
              </div>
            )}
