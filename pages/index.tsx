...
export default function Home() {
  ...
  <div className="hidden md:block">
   ...
   >
    ...
    <path 
      d="M100,120 C120,125 130,130 150,130 C170,130 180,115 200,110 C220,105 230,100 250,100 C270,100 280,115 300,120 C320,125 330,100 350,90 C370,80 380,75 400,80 C420,85 430,95 450,100 C470,105 480,95 500,90 C520,85 530,100 550,110 C570,120 580,90 600,80 C620,70 630,95 650,100 C670,105 680,95 700,90 L700,340 C680,335 670,320 650,330 C630,340 620,360 600,350 C580,340 570,310 550,320 C530,330 520,355 500,340 C480,325 470,300 450,310 C430,320 420,335 400,330 C380,325 370,310 350,320 C330,330 320,355 300,350 C280,345 270,340 250,330 C230,320 220,295 200,310 C180,325 170,345 150,340 C130,335 120,325 100,320 Z" 
      fill="#E1F5FE" 
      fillOpacity="0.6"
    />
    ...
    <circle cx="100" cy="260" r="7" fill="white" stroke="#0F9D58" strokeWidth="2"/>
    <circle cx="700" cy="280" r="7" fill="white" stroke="#0F9D58" strokeWidth="2"/>
    
    {/* Labels */}
    <text x="150" y="90" fontFamily="Arial" fontSize="14" fontWeight="bold" fill="#4285F4">Upper Band</text>
    <text x="150" y="370" fontFamily="Arial" fontSize="14" fontWeight="bold" fill="#DB4437">Lower Band</text>
  </svg>
</div>
            </div>
          </div>
