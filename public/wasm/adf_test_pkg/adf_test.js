 ...
 * @param {any} critical_values_js
 * @param {any} p_value_tables_js
 * @returns {AdfResult}
 */
export function get_adf_p_value_and_stationarity(test_statistic, sample_size, critical_values_js, p_value_tables_js) {
    const ret = wasm.get_adf_p_value_and_stationarity(test_statistic, sample_size, critical_values_js, p_value_tables_js);
