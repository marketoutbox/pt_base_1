/* tslint:disable */
/* eslint-disable */
export function get_adf_p_value_and_stationarity(test_statistic: number, sample_size: number, critical_values_js: any, p_value_tables_js: any): AdfResult;
...
export interface InitOutput {
  ...
  readonly get_adf_p_value_and_stationarity: (a: number, b: number, c: any, d: any) => number;
