// public/workers/kalman-worker.js
...
self.onmessage = async (event) => {
  ...
  if (type === "runAnalysis") {
    ...
    try {
      ...
      const kalmanResults = commonUtils.kalmanFilter(
        data.pricesA,
        data.pricesB,
      ...
      const rollingStatsWindow = params.kalmanInitialLookback
      ...
      console.error("Error in Kalman worker:", e)
      error = e.message || "An unknown error occurred during Kalman analysis."
    } finally {
